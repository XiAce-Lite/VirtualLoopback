...
1. **システム再生音**（既定）… PC 全体の再生ミックス
2. **アプリ: …** … 個別アプリ（複数トラックに挿して別アプリを選べます）
3. **デバイス: …** … 特定の再生エンドポイント（従来どおり）
...
- Windows のアプリ単位キャプチャは **Windows 10 version 2004（ビルド 19041）以降 / Windows 11** が必要です
